...
export default function GameLauncherSlider() {
  ...
  const [currentSlide, setCurrentSlide] = useState(0) // 0: categoria, 1: quiz, 2: configurazione
  ...
  const handleCategorySelect = (category) => {
    try {
      ...
      // Slide verso sinistra alla selezione quiz
      setCurrentSlide(1)
    } catch (error) {
  ...
  const handleQuizSelect = async (quiz) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        // Slide verso sinistra alla configurazione
        setCurrentSlide(2)
      } else {
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600 text-sm">
              ...
              {currentSlide === 2 && `Configurazione: ${selectedQuiz?.title}`}
            </p>
          </div>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6 py-6">
                      {categories.map((category) => (
                        ...
                        >
                          ...
                          <div className="font-semibold text-gray-900 text-lg mb-1">{category}</div>
          ...
          <div className="w-full flex-shrink-0 p-6">
            <div className="h-full flex flex-col">
              <div className="text-center mb-8">
                ...
                <h3 className="text-3xl font-bold text-gray-900 mb-2">{selectedCategory}</h3>
                          ...
                          <div className="flex-1">
                            ...
                            <div className="flex flex-wrap gap-4 text-sm text-gray-600">
                              ...
                              <span className="flex items-center">
                                ...
                                Tempo medio: {quiz.questions?.length > 0 ?
                                  Math.round(quiz.questions.reduce((sum, q) => sum + (q.time || 15), 0) / quiz.questions.length) : 15
                                }s
                              </span>
                              <span className="flex items-center">
                                <span className="mr-1">🎯</span>
                                {(quiz.questions?.length || 0) * 1000} punti max
                              </span>
                              {quiz.password && (
                                <span className="flex items-center">
                                  <span className="mr-1">🔑</span>
                    ...
                    <div className="bg-white rounded-xl p-6 shadow-md">
                      ...
                      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                        ...
                        <div className="text-center p-4 bg-purple-50 rounded-lg">
                          <div className="text-2xl font-bold text-purple-600">{selectedQuiz.questions.length * 1000}</div>
